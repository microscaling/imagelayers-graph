...
describe('Controller: BadgedialogCtrl', function() {
  ...
  describe('$scope.badgeAsHtml', function() {
    it('should return an HTML embed code', function() {
      ...
      expect(embedCode.$$unwrapTrustedValue()).toEqual(
        "<a href='https://imagelayers.io/?images=node:latest' title='Get your own badge on imagelayers.io'><img src='https://imagelayers.io/badge/node:latest.svg'></a>"
      );
    });
  });
  ...
  describe('$scope.badgeAsMarkdown', function() {
    it('should return a Markdown embed code', function() {
      ...
      expect(embedCode).toEqual(
        "[![](https://imagelayers.io/badge/node:latest.svg)](https://imagelayers.io/?images=node:latest 'Get your own badge on imagelayers.io')"
      );
    });
  });
  ...
  describe('$scope.badgeAsAsciiDoc', function() {
    it('should return AsciiDoc embed code', function() {
      ...
      expect(embedCode).toEqual(
        'image:https://badge.imagelayers.io/node:latest.svg[title="Get your own badge on imagelayers.io", alt="Get your own badge on imagelayers.io", link="https://imagelayers.io/?images=node:latest"]'
      );
    });
  });
});
